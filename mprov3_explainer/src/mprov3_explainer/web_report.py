...
def write_fold_explanation_web_report(
    ...
    sum_cols = [
        ...
        ("mean_paper_sufficiency", "Mean Fsuf", "num"),
        ("mean_paper_comprehensiveness", "Mean Fcom", "num"),
        ("mean_paper_f1_fidelity", "Mean Ff1", "num"),
...
_GLOBAL_METRIC_KEYS = [
    ...
    ("mean_paper_sufficiency", "Mean Fsuf"),
    ("mean_paper_comprehensiveness", "Mean Fcom"),
    ("mean_paper_f1_fidelity", "Mean Ff1"),
    ("num_valid", "Valid"),
    ("wall_time_s", "Wall (s)"),
]
